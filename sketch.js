...
function draw()
{
  ...
  SSoundOOn.position(displayWidth/2-55, displayHeight/2);
  SSoundOOff.position(displayWidth/2-55, displayHeight/2);
  resumee.position(displayWidth/2-39, displayHeight/2-30);
